...
# Готово - Проверка документов по номеру
...
# Готово Поиск имени по документу
...
# Готово - Список владельцев документов
...
# Готово - Удаление документа с полки
...
# Готово - добавление документа на полку
...
# Готово - удаление документа
def delete_doc(user_doc_number='10006'):
    doc_exist = check_document_existance(user_doc_number)
    if doc_exist:
        for current_document in documents:
            doc_number = current_document['number']
...
# Готово - поиск полки по номеру документа
...
# Готово- перемещение документа на полку
...
# Готово - показать информацию по документу
...
# Готово - показать список всех документов
...
# Готово- добавление нового документа
def add_new_doc(new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number):
    ...
    return new_doc_shelf_number, True
